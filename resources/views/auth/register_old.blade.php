		...
		<div id="main" role="main">
			...
			<div id="content" class="container">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 hidden-xs hidden-sm">
						...
						<div class="hero">
							...
							<img src="img/sales-purchase-agreement.png" alt="" class="pull-right display-image" style="width:210px">
              ...
              @if ($errors->has('name'))
                                    ...
                                    @endif
							<form action="{{ url('/register') }}" id="smart-form-register" class="smart-form client-form" method="post">
                {{ csrf_field() }}
								<header>
                  ...
                  <section>
                    <label class="select">
                      <select name="registration_type" required>
                        <option value="0" selected="" disabled="">Registration Type</option>
                        <option value="role_marketeer">Marketeer</option>
                        <option value="role_lawyer">Lawyer Firm</option>
                        <option value="role_lms">LMS</option>
                      </select> <i></i> </label>
									</section>

									<section>
										<label class="input"> <i class="icon-append fa fa-user"></i>
											<input id="name" class="{{ $errors->has('name') ? 'alert alert-danger' : '' }}" value="{{ old('name') }}" autofocus required type="text" name="name" placeholder="Full name as per IC / Company name as per ssm">

									</section>

                  <section>
                    <label class="input"> <i class="icon-append fa fa-user"></i>
                      <input required type="text" name="ic" placeholder="IC no / Business registration no">

                  </section>

									<section>
										<label class="input"> <i class="icon-append fa fa-envelope"></i>
											<input id="email" required type="email" name="email" placeholder="Email address" value="{{ old('email') }}">
								...
								<fieldset>
									<div class="row">
										<section class="col col-6">
											<label class="input">
												<input type="text" name="hp_no" placeholder="Hp No">
											</label>
										</section>
										<section class="col col-6">
											<label class="input">
												<input type="text" name="referral_name" placeholder="Referral Name (Optional)">
											</label>
										</section>
									</div>
