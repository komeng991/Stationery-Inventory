															                ...
															                <tbody>
															                    ...
															                    @foreach($users as $user)
															                      <tr>
															                        ...
															                        <td>{{$UserRoles[$user->user->id]}}</td>
															                        <td style="width:200px;">

																												<div class='d-flex mt-2'>
													                            	<a href='{{ URL::to('users/' . $user->user->id . '/edit') }}' class='btn btn-sm btn-outline-primary mr-2' title='Edit'>
													                            		<i class="fal fa-edit"></i> Edit
													                            	</a>
																												{{ Form::open(array('url' => 'users/' . $user->user->id, 'class' => 'pull-right')) }}
																														 {{ Form::hidden('_method', 'DELETE') }}
																														 <button class="btn btn-sm btn-outline-danger mr-2">
																															 <i class="fal fa-times"></i>  Delete
																														 </button>
																												{{ Form::close() }}
	                            													</div>
